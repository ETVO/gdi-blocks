<?php
/**
 * Plugin Name: GDI Layout Blocks
 * Description: Blocos de layout criados exclusivamente para o site GDI
 * Author: MinimalQ
 * Author URI: https://www.minimalq.com
 * Version: 1.0
 * 
 * @package WordPress
 * @subpackage GDI-Block
 */
...
// Core constants 
define("PLUGIN_DIR", plugin_dir_path(__DIR__) . "gdi-blocks/");
define("PLUGIN_URL", plugins_url("gdi-blocks/"));
define("PLUGIN_CLASS", "GDI_Blocks");

/**
 * GDI Blocks plugin
 */
final class GDI_Blocks {
